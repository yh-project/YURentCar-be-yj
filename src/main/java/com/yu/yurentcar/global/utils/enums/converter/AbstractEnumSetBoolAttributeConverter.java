...
@Getter
public abstract class AbstractEnumSetBoolAttributeConverter<E extends Enum<E> & EnumValue<T>, T>
implements AttributeConverter<EnumSet<E>, boolean[]> {
    private final Class<E> targetEnumClass;
    private final boolean nullable;
    private final String enumName;

    public AbstractEnumSetBoolAttributeConverter(Class<E> targetEnumClass, boolean nullable, String enumName) {
    ...
    @Override
    public boolean[] convertToDatabaseColumn(EnumSet<E> attribute) {
        ...
        return EnumValueConvertUtils.toBoolListCode(targetEnumClass, attribute);
    }

    @Override
    public EnumSet<E> convertToEntityAttribute(boolean[] dbData) {
        ...
        return EnumValueConvertUtils.ofBoolListCode(targetEnumClass, dbData);
    }
}
